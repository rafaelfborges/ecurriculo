...
<body class="bg-dark">
  <div class="p-3 h-75 d-flex flex-column">
    ...
    <div class="container bg-light border border-dark rounded">
      <?php 
        include_once $path . "src/curriculo/content/ContentListCurriculos.php";
        include_once $path . "src/curriculo/content/ModalCadastrarExperiencia.php";
        include_once $path . "src/curriculo/content/ModalEditarInfos.php";
        include_once $path . "src/curriculo/content/ModalExperiencia.php";
      ?>
    </div>
