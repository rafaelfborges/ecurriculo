...
<body class="bg-dark">
  <div class="p-3 h-75 d-flex flex-column">
    ...
    <div class="text-center">
      <h2>Pesquisa Cadastro</h2>
    </div>
    
    <!-- Content Section -->
    <div class="container bg-light border border-dark rounded">
      <?php 
        include_once $path . "src/cadastro/content/ContentListCadastro.php";
        include_once $path . "src/cadastro/content/ModalEditarCadastro.php";
        include_once $path . "src/cadastro/content/ModalCadastrarCurriculo.php";
        include_once $path . "src/cadastro/content/ModalCadastrarSolicitacao.php";
      ?>
    </div>
